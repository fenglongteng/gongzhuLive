...
- (void)setupDefault
{
    ...
    _borderButtonColor = [UIColor clearColor];
    _heightPicker      = 240;
...
- (UIView *)contentView
{
    if (!_contentView) {
        ...
        colorLayer.frame = CGRectMake(0, 0, screenWidth, 40);
        colorLayer.backgroundColor = UIColorFromRGB(0xb433ff).CGColor;
...
//        //自定义边框
//        [_buttonLeft addBorderColor:[UIColor clearColor]];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
       ...
       // [_buttonRight addBorderColor:self.borderButtonColor];
        //自定义边框
       // [_buttonRight addBorderColor:[UIColor clearColor]];
...
- (UILabel *)labelTitle
{
    if (!_labelTitle) {
        ...
        //自定义
        [_labelTitle setFont:[UIFont systemFontOfSize:18]];
