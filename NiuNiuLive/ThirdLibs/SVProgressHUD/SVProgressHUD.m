...
+ (NSTimeInterval)displayDurationForString:(NSString*)string {
    return MAX((float)string.length * 0.25 + 0.5, [self sharedView].minimumDismissTimeInterval);
}
...
- (UIView*)hudView {
    ...
    _hudView.backgroundColor = self.defaultStyle == SVProgressHUDStyleCustom ? self.backgroundColor : [UIColor blackColor];
#else
