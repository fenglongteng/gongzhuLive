...
@property(nullable,weak)UIView * backView;
@property (weak, nullable) IBOutlet UIImageView *rotationImage;
@property (weak, nonatomic) IBOutlet UIImageView *rotationImageY;
