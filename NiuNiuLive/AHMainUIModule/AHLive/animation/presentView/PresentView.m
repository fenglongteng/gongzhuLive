...
- (void)setModel:(GiftModel *)model {
    _model = model;
    [_headImageView sd_setImageWithURL:[NSString getImageUrlString:model.headImageUrl] placeholderImage:[UIImage imageNamed:@"logo_500.jpg"]];
    [_giftImageView sd_setImageWithURL:[NSString getImageUrlString:model.giftUrl]];
