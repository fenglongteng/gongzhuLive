...
static const NSInteger placeHoldTextViewTag = 200;
...
- (void)addPlaceHolder:(NSString*)placeHolder placeHoloderTextColor:(UIColor*)placeHoloderTextColor{
    ...
    if(![self placeHolderTextView]) {
        ...
        textView.tag = placeHoldTextViewTag;
...
-(void)hidePlaceHold{
    UIView *view = [self viewWithTag:placeHoldTextViewTag];
    [view removeFromSuperview];
}
#pragma mark - 不需要自己显示和隐藏
